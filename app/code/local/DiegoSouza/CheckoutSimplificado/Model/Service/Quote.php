<?php
class DiegoSouza_CheckoutSimplificado_Model_Service_Quote extends Mage_Sales_Model_Service_Quote
{
    protected function _validate()
    {
        ...
        if (!$this->getQuote()->isVirtual())
        {
            ...
            $addrValidator = Mage::getSingleton('checkoutsimplificado/type_geo')->validateAddress($address);
        ...
        $addrValidator = Mage::getSingleton('checkoutsimplificado/type_geo')->validateAddress($this->getQuote()->getBillingAddress());
